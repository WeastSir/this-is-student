...
<div class="tl-item"><div class="tl-num tl-num-b">2</div><div class="tl-head" onclick="this.parentElement.classList.toggle('open')"><div><div class="tl-title">Competitive Set (Mitbewerbsanalyse)</div><div class="tl-merksatz">«Mind. 4 Hotels, die um dieselben Gastnächte konkurrieren.»</div></div><div class="tl-arrow">&#9654;</div></div><div class="tl-detail"><div class="tl-body">Das CompSet besteht aus mind. <strong>4 vergleichbaren Betrieben</strong>. Massgeblich: direkte Konkurrenz um Gastnächte. In wettbewerbsstarken Märkten auch je ein Hotel der höheren/niedrigeren Kategorie einbeziehen. Analyse nach: <strong>Preis-Positionierung</strong> und <strong>Online-Reviews</strong> → Preis-Bewertungsmatrix. Besonders problematisch: Hotels die <strong>günstiger UND besser bewertet</strong> sind (= Handlungsbedarf!).</div><div class="tl-sub"><div class="c ca"><div class="ct2">Faktoren zur CompSet-Definition</div><div class="cd">Lage, Grösse, Positionierung, Bewertungen, Preislage, Stil, Segmentation, Hotelkette, Sterne</div></div><div class="c cr"><div class="ct2">Betrügerische Aktivitäten</div><div class="cd">Selbst geschriebene Bewertungen sind ausdrücklich ausgeschlossen!</div></div></div><div class="merksatz">Merke: Es besteht ein direkter Zusammenhang zwischen Online-Reviews, Positionierung und Preis.</div><div style="margin:16px 0;padding:20px;background:var(--s2);border-radius:12px;border:1px solid var(--bd)">
<div style="font-size:13px;font-weight:700;color:var(--am);margin-bottom:12px;text-transform:uppercase;letter-spacing:1px">Preis-Bewertungsmatrix</div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:0;border-radius:8px;overflow:hidden;margin-bottom:8px">
<div style="background:rgba(232,79,56,.06);padding:16px;border:1px solid var(--bd)"><div style="font-size:11px;font-weight:600;color:var(--r);margin-bottom:6px">Teurer &amp; schlechter bewertet</div><div style="font-size:12px;color:var(--tx3)">z.B. Valbella Inn, Posthotel, Sunstar</div></div>
<div style="background:rgba(56,232,156,.04);padding:16px;border:1px solid var(--bd)"><div style="font-size:11px;font-weight:600;color:var(--g);margin-bottom:6px">Teurer &amp; besser bewertet</div><div style="font-size:12px;color:var(--tx3)">z.B. Schweizerhof (5★)</div></div>
<div style="background:rgba(232,168,56,.04);padding:16px;border:1px solid var(--bd)"><div style="font-size:11px;font-weight:600;color:var(--am);margin-bottom:6px">Günstiger &amp; schlechter bewertet</div><div style="font-size:12px;color:var(--tx3)">z.B. Kurhaus, Lenzerhorn</div></div>
<div style="background:rgba(56,182,232,.06);padding:16px;border:1px solid var(--bd)"><div style="font-size:11px;font-weight:600;color:var(--ac);margin-bottom:6px">⚠ Günstiger &amp; besser bewertet</div><div style="font-size:12px;color:var(--tx3)">z.B. Bestzeit Parp. → Handlungsbedarf!</div></div>
</div>
<div style="text-align:center;font-size:11px;color:var(--tx3)">Mein Hotel steht im Zentrum. Diagonal = faire Positionierung.</div>
</div></div></div>
...
<div class="tl-item"><div class="tl-num tl-num-g">4</div><div class="tl-head" onclick="this.parentElement.classList.toggle('open')"><div><div class="tl-title">Kennzahlen im Benchmarking</div><div class="tl-merksatz">«Market Shares (%) vs. Indices (100=Durchschnitt). ARI × MPI ≠ RGI!»</div></div><div class="tl-arrow">&#9654;</div></div><div class="tl-detail"><div class="tl-body"><strong>Zwei Vergleichsgruppen:</strong> CompSet (nur Mitbewerber) vs. <strong>Market</strong> (CompSet + mein Hotel). Prüfung rechnet IMMER mit Market!<br><br><strong>Market Shares</strong> (Ergebnis in %):<br>• <strong>FMS</strong> = Zimmer Hotel / Zimmer Market × 100 (Kapazitätsanteil)<br>• <strong>AMS</strong> = Sold RN Hotel / Sold RN Market × 100 (Nachfrageanteil)<br>• <strong>RMS</strong> = Revenue Hotel / Revenue Market × 100 (Umsatzanteil)<br><br><strong>Indices</strong> (100 = Marktdurchschnitt):<br>• <strong>MPI</strong> = Occ% Hotel / Occ% Market × 100 (voller oder leerer?)<br>• <strong>ARI</strong> = ADR Hotel / ADR Market × 100 (teurer oder günstiger?)<br>• <strong>RGI</strong> = RevPAR Hotel / RevPAR Market × 100 (<strong>WICHTIGSTE!</strong> Gesamtperformance)</div><div class="tl-sub"><div class="c cg"><div class="ct2">Über 100 = besser als Markt</div><div class="cd">Weiter so! Das Hotel performt überdurchschnittlich.</div></div><div class="c cr"><div class="ct2">Unter 100 = schlechter als Markt</div><div class="cd">Handlungsbedarf! Underperforming gegenüber Konkurrenz.</div></div><div class="c cm"><div class="ct2">Kombination: RGI hoch + ARI tief + MPI hoch</div><div class="cd">= Zu günstig! Preis erhöhen. Auch mit weniger Gästen steigt der RevPAR.</div></div><div class="c cp"><div class="ct2">Kombination: RGI tief + ARI hoch + MPI tief</div><div class="cd">= Zu teuer! Preis senken, um mehr Gäste zu gewinnen.</div></div></div><div style="margin:16px 0;padding:20px;background:var(--s2);border-radius:12px;border:1px solid var(--bd)">
<div style="font-size:13px;font-weight:700;color:var(--am);margin-bottom:12px;text-transform:uppercase;letter-spacing:1px">Benchmarking-Systematik</div>
<div style="display:flex;flex-wrap:wrap;gap:6px;margin-bottom:12px;justify-content:center">
<span style="padding:6px 12px;border-radius:8px;background:var(--s);border:1px solid var(--bd);font-size:11px;color:var(--tx2)">Supply</span>
<span style="padding:6px 12px;border-radius:8px;background:var(--aml);border:1px solid var(--am);font-size:11px;color:var(--am);font-weight:600">Occupancy</span>
<span style="padding:6px 12px;border-radius:8px;background:var(--s);border:1px solid var(--bd);font-size:11px;color:var(--tx2)">Demand</span>
<span style="padding:6px 12px;border-radius:8px;background:rgba(56,182,232,.1);border:1px solid var(--ac);font-size:11px;color:var(--ac);font-weight:600">ADR</span>
<span style="padding:6px 12px;border-radius:8px;background:var(--s);border:1px solid var(--bd);font-size:11px;color:var(--tx2)">Revenue</span>
<span style="padding:6px 12px;border-radius:8px;background:var(--gl);border:1px solid var(--g);font-size:11px;color:var(--g);font-weight:600">RevPAR</span>
</div>
<div style="text-align:center;font-size:11px;color:var(--tx3);margin-bottom:10px">↓ Hotel / Market ↓</div>
<div style="display:flex;flex-wrap:wrap;gap:6px;justify-content:center">
<span style="padding:6px 12px;border-radius:8px;background:var(--s);border:1px solid var(--bd);font-size:11px;color:var(--tx3)">FMS <small>(Share)</small></span>
<span style="padding:6px 12px;border-radius:8px;background:var(--aml);border:1px solid var(--am);font-size:11px;color:var(--am);font-weight:600">MPI <small>(Index)</small></span>
<span style="padding:6px 12px;border-radius:8px;background:var(--s);border:1px solid var(--bd);font-size:11px;color:var(--tx3)">AMS <small>(Share)</small></span>
<span style="padding:6px 12px;border-radius:8px;background:rgba(56,182,232,.1);border:1px solid var(--ac);font-size:11px;color:var(--ac);font-weight:600">ARI <small>(Index)</small></span>
<span style="padding:6px 12px;border-radius:8px;background:var(--s);border:1px solid var(--bd);font-size:11px;color:var(--tx3)">RMS <small>(Share)</small></span>
<span style="padding:6px 12px;border-radius:8px;background:var(--rl);border:1px solid var(--r);font-size:11px;color:var(--r);font-weight:700">RGI ★ <small>(Index)</small></span>
</div>
<div style="text-align:center;margin-top:10px;font-size:11px;color:var(--tx3)">Grau = Shares (%) · Farbig = Indices (100 = Marktdurchschnitt)</div>
</div><div class="hlr"><strong>ACHTUNG:</strong> ARI × MPI ≠ RGI! Die Indices sind NICHT multiplikativ verknüpft! Prüfung: IMMER mit Market rechnen, IMMER Lösungsweg aufschreiben!</div></div></div>
...
<div class="tl-item"><div class="tl-num tl-num-p">6</div><div class="tl-head" onclick="this.parentElement.classList.toggle('open')"><div><div class="tl-title">Product Life Cycle (PLC)</div><div class="tl-merksatz">«4 Phasen mit typischen Index-Werten — Immer neue Produkte in der Pipeline!»</div></div><div class="tl-arrow">&#9654;</div></div><div class="tl-detail"><div class="tl-body">Der Produktlebenszyklus (Vernon 1966, Hirsch 1967) unterteilt das Leben eines Produkts in 4 Phasen:</div><div class="tl-sub"><div class="c ca"><div class="ct2">Introduction (ARI 0.72 / MPI 0.84 / RGI 0.78)</div><div class="cd">«Heads in beds» aufbauen. Penetration, Eröffnungs-Specials. Noch keine Gewinne. Endet beim Break-even.</div></div><div class="c cg"><div class="ct2">Growth (ARI 0.89 / MPI 1.01 / RGI 0.96)</div><div class="cd">Erst Occ% steigern, dann ADR steigern. Erstmals Gewinne. Konkurrenz wird aufmerksam (Free-Rider).</div></div><div class="c cm"><div class="ct2">Maturity (ARI 1.12 / MPI 1.09 / RGI 1.11)</div><div class="cd">Längste &amp; profitabelste Phase. Maximize RevPAR. Hotels: Kapazität erhöhen oder Produkt upgraden.</div></div><div class="c cr"><div class="ct2">Decline (ARI 1.21 / MPI 0.67 / RGI 0.78)</div><div class="cd">Markt schrumpft. Optionen: Relaunch oder Exit. Hotels: Investitionsstau vermeiden!</div></div></div><div style="margin:16px 0;padding:20px;background:var(--s2);border-radius:12px;border:1px solid var(--bd)">
<div style="font-size:13px;font-weight:700;color:var(--pr);margin-bottom:12px;text-transform:uppercase;letter-spacing:1px">Product Life Cycle — Balkendiagramm</div>
<div style="display:flex;align-items:flex-end;gap:8px;height:120px;padding:10px 0;justify-content:center">
<div style="display:flex;flex-direction:column;align-items:center;flex:1;max-width:80px;justify-content:flex-end"><div style="width:100%;height:25%;background:var(--ac);border-radius:6px 6px 0 0;min-height:10px"></div><div style="font-size:9px;color:var(--tx3);margin-top:4px;text-align:center">Introduction</div></div>
<div style="display:flex;flex-direction:column;align-items:center;flex:1;max-width:80px;justify-content:flex-end"><div style="width:100%;height:60%;background:var(--g);border-radius:6px 6px 0 0;min-height:10px"></div><div style="font-size:9px;color:var(--tx3);margin-top:4px;text-align:center">Growth</div></div>
<div style="display:flex;flex-direction:column;align-items:center;flex:1;max-width:80px;justify-content:flex-end"><div style="width:100%;height:100%;background:var(--am);border-radius:6px 6px 0 0;min-height:10px"></div><div style="font-size:9px;color:var(--tx3);margin-top:4px;text-align:center">Maturity</div></div>
<div style="display:flex;flex-direction:column;align-items:center;flex:1;max-width:80px;justify-content:flex-end"><div style="width:100%;height:75%;background:var(--am);border-radius:6px 6px 0 0;min-height:10px;opacity:.7"></div><div style="font-size:9px;color:var(--tx3);margin-top:4px;text-align:center">Sättigung</div></div>
<div style="display:flex;flex-direction:column;align-items:center;flex:1;max-width:80px;justify-content:flex-end"><div style="width:100%;height:35%;background:var(--r);border-radius:6px 6px 0 0;min-height:10px"></div><div style="font-size:9px;color:var(--tx3);margin-top:4px;text-align:center">Decline</div></div>
</div>
</div><div class="merksatz">Merke: Immer neue Produkte in der Pipeline haben um aktuell zu bleiben!</div></div></div>
...
<div class="tl-item"><div class="tl-num tl-num-g">2</div><div class="tl-head" onclick="this.parentElement.classList.toggle('open')"><div><div class="tl-title">Revenue-Management-Prozess</div><div class="tl-merksatz">«Kreislauf: Forecast → Optimize → Control → Monitor → 🔁»</div></div><div class="tl-arrow">&#9654;</div></div><div class="tl-detail"><div class="tl-body">Drei Ziele: <strong>Kontinuierliche Applikation</strong>, <strong>personelle Unabhängigkeit</strong>, <strong>kontinuierliche Verbesserung</strong>.<br><br><strong>1. Forecast:</strong> Endbuchungsstand pro Anreisedatum, Segment und Aufenthaltsdauer abschätzen.<br><strong>2. Optimize:</strong> Verbleibende Nachfrage vs. verfügbare Zimmer.<br><strong>3. Control:</strong> Restriktionen (MinLOS, CTA, CTD), Overbooking Factor, BAR anpassen.<br><strong>4. Monitor:</strong> Erfolg messen, Erfahrungen in zukünftige Zyklen übernehmen. Wash-Factor beachten!</div><div style="margin:16px 0;padding:20px;background:var(--s2);border-radius:12px;border:1px solid var(--bd)">
<div style="font-size:13px;font-weight:700;color:var(--g);margin-bottom:12px;text-transform:uppercase;letter-spacing:1px">Revenue Optimization Circle</div>
<div style="display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:8px;margin-bottom:12px">
<div style="padding:12px 18px;border-radius:10px;background:rgba(56,182,232,.1);border:1.5px solid var(--ac);text-align:center"><div style="font-size:12px;font-weight:700;color:var(--ac)">1. Forecast</div><div style="font-size:10px;color:var(--tx3)">Nachfrageprognose</div></div>
<span style="color:var(--am);font-size:18px">→</span>
<div style="padding:12px 18px;border-radius:10px;background:var(--gl);border:1.5px solid var(--g);text-align:center"><div style="font-size:12px;font-weight:700;color:var(--g)">2. Optimize</div><div style="font-size:10px;color:var(--tx3)">Nachfrage vs. Kapazität</div></div>
<span style="color:var(--am);font-size:18px">→</span>
<div style="padding:12px 18px;border-radius:10px;background:var(--aml);border:1.5px solid var(--am);text-align:center"><div style="font-size:12px;font-weight:700;color:var(--am)">3. Control</div><div style="font-size:10px;color:var(--tx3)">Entscheidungen</div></div>
<span style="color:var(--am);font-size:18px">→</span>
<div style="padding:12px 18px;border-radius:10px;background:var(--pl);border:1.5px solid var(--pr);text-align:center"><div style="font-size:12px;font-weight:700;color:var(--pr)">4. Monitor</div><div style="font-size:10px;color:var(--tx3)">Erfolg messen</div></div>
<span style="color:var(--am);font-size:18px">🔁</span>
</div>
<div style="display:flex;gap:6px;flex-wrap:wrap;justify-content:center">
<span style="padding:4px 10px;border-radius:6px;background:var(--aml);font-size:10px;color:var(--am);font-weight:600">MinLOS</span>
<span style="padding:4px 10px;border-radius:6px;background:var(--aml);font-size:10px;color:var(--am);font-weight:600">CTA/CTD</span>
<span style="padding:4px 10px;border-radius:6px;background:var(--aml);font-size:10px;color:var(--am);font-weight:600">Overbooking</span>
<span style="padding:4px 10px;border-radius:6px;background:var(--aml);font-size:10px;color:var(--am);font-weight:600">BAR</span>
</div>
</div><div class="hlr"><strong>GIGA — Garbage In, Garbage Out!</strong> Ohne korrekte Dateneingabe funktioniert RM nicht.</div><div class="merksatz">New School: Forecast Accuracy dem operativen Ergebnis unterordnen.</div></div></div>
...
<div class="tl-item"><div class="tl-num tl-num-r">4</div><div class="tl-head" onclick="this.parentElement.classList.toggle('open')"><div><div class="tl-title">Market Segmentation</div><div class="tl-merksatz">«Eindeutig, jeder Gast genau einem Segment — 4 Hauptsegmente.»</div></div><div class="tl-arrow">&#9654;</div></div><div class="tl-detail"><div class="tl-body">Grundsätze: Segmentierung <strong>eindeutig</strong>, jeder Gast <strong>ausschliesslich einem</strong> Segment. Klassische 2-stufige Hierarchie:</div><div class="tl-sub"><div class="c ca"><div class="ct2">Leisure Individual</div><div class="cd">Feriengäste, einzeln buchend. Hohe Lead Time, preissensitiv, flexible Daten.</div></div><div class="c cg"><div class="ct2">Corporate/Business Individual</div><div class="cd">Geschäftsreisende. Kurze Lead Time, weniger preissensitiv, fixe Daten.</div></div><div class="c cm"><div class="ct2">Leisure Groups</div><div class="cd">Reisegruppen, Tour Operators. Lange Lead Time, tiefe Raten.</div></div><div class="c cp"><div class="ct2">Business Groups (MICE)</div><div class="cd">Meetings, Incentives, Conventions. Zusatzumsatz F&amp;B + Technik.</div></div></div><div class="merksatz"><div style="margin:16px 0;padding:20px;background:var(--s2);border-radius:12px;border:1px solid var(--bd)">
<div style="font-size:13px;font-weight:700;color:var(--r);margin-bottom:12px;text-transform:uppercase;letter-spacing:1px">Klassische Segmentierung</div>
<div style="display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:6px;margin-bottom:10px">
<div style="padding:8px 16px;border-radius:8px;background:var(--aml);border:1.5px solid var(--am);font-size:12px;font-weight:700;color:var(--am)">Alle Gäste</div>
<span style="color:var(--tx3)">→</span>
<div style="padding:8px 16px;border-radius:8px;background:rgba(56,182,232,.1);border:1.5px solid var(--ac);font-size:12px;font-weight:600;color:var(--ac)">Individual</div>
<span style="color:var(--tx3)">/</span>
<div style="padding:8px 16px;border-radius:8px;background:var(--pl);border:1.5px solid var(--pr);font-size:12px;font-weight:600;color:var(--pr)">Gruppen</div>
</div>
<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:6px">
<div style="padding:10px;border-radius:8px;background:var(--s);border:1px solid var(--bd);text-align:center"><div style="font-size:11px;font-weight:700;color:var(--ac)">Leisure Ind.</div><div style="font-size:9px;color:var(--tx3)">Hohe Lead Time, preissensitiv</div></div>
<div style="padding:10px;border-radius:8px;background:var(--s);border:1px solid var(--bd);text-align:center"><div style="font-size:11px;font-weight:700;color:var(--g)">Corporate Ind.</div><div style="font-size:9px;color:var(--tx3)">Kurze Lead Time, fixe Daten</div></div>
<div style="padding:10px;border-radius:8px;background:var(--s);border:1px solid var(--bd);text-align:center"><div style="font-size:11px;font-weight:700;color:var(--pr)">Leisure Groups</div><div style="font-size:9px;color:var(--tx3)">Lange Lead Time, tiefe Raten</div></div>
<div style="padding:10px;border-radius:8px;background:var(--s);border:1px solid var(--bd);text-align:center"><div style="font-size:11px;font-weight:700;color:var(--am)">MICE Groups</div><div style="font-size:9px;color:var(--tx3)">Zusatzumsatz F&amp;B + Technik</div></div>
</div>
</div>Plus Segment «Others» als Sammelbecken.</div></div></div>
...
<div id="rmqStats" style="margin-bottom:20px">
<div style="display:flex;gap:8px;margin-bottom:14px;flex-wrap:wrap">
<div class="qsc" style="flex:1;min-width:70px"><div class="qsn" id="rmqTotR" style="color:var(--g)">0</div><div class="qsl">Total richtig</div></div>
<div class="qsc" style="flex:1;min-width:70px"><div class="qsn" id="rmqTotW" style="color:var(--r)">0</div><div class="qsl">Total falsch</div></div>
<div class="qsc" style="flex:1;min-width:70px"><div class="qsn" id="rmqTotP" style="color:var(--ac)">0%</div><div class="qsl">Erfolgsquote</div></div>
</div>
<div style="font-size:12px;color:var(--tx3);margin-bottom:6px">Lernerfolg</div>
<div style="display:flex;gap:4px;margin-bottom:4px;align-items:center"><div style="width:10px;height:10px;border-radius:50%;background:var(--g);flex-shrink:0"></div><div style="font-size:12px;color:var(--tx2);width:70px">Sicher</div><div style="flex:1;height:8px;background:var(--s2);border-radius:4px;overflow:hidden"><div id="rmqBarG" style="height:100%;background:var(--g);border-radius:4px;transition:width .5s;width:0%"></div></div><div style="font-size:12px;color:var(--tx2);width:30px;text-align:right" id="rmqBarGn">0</div></div>
<div style="display:flex;gap:4px;margin-bottom:4px;align-items:center"><div style="width:10px;height:10px;border-radius:50%;background:var(--am);flex-shrink:0"></div><div style="font-size:12px;color:var(--tx2);width:70px">Wackelig</div><div style="flex:1;height:8px;background:var(--s2);border-radius:4px;overflow:hidden"><div id="rmqBarO" style="height:100%;background:var(--am);border-radius:4px;transition:width .5s;width:0%"></div></div><div style="font-size:12px;color:var(--tx2);width:30px;text-align:right" id="rmqBarOn">0</div></div>
<div style="display:flex;gap:4px;margin-bottom:4px;align-items:center"><div style="width:10px;height:10px;border-radius:50%;background:var(--r);flex-shrink:0"></div><div style="font-size:12px;color:var(--tx2);width:70px">Unsicher</div><div style="flex:1;height:8px;background:var(--s2);border-radius:4px;overflow:hidden"><div id="rmqBarR" style="height:100%;background:var(--r);border-radius:4px;transition:width .5s;width:0%"></div></div><div style="font-size:12px;color:var(--tx2);width:30px;text-align:right" id="rmqBarRn">0</div></div>
<div style="display:flex;gap:4px;align-items:center"><div style="width:10px;height:10px;border-radius:50%;background:var(--tx3);flex-shrink:0"></div><div style="font-size:12px;color:var(--tx2);width:70px">Noch offen</div><div style="flex:1;height:8px;background:var(--s2);border-radius:4px;overflow:hidden"><div id="rmqBarX" style="height:100%;background:var(--tx3);border-radius:4px;transition:width .5s;width:100%"></div></div><div style="font-size:12px;color:var(--tx2);width:30px;text-align:right" id="rmqBarXn">0</div></div>
</div>
<div class="pb"><div class="pf" id="rmqP"></div></div><div class="pt" id="rmqPT">Frage 1</div>
<div id="rmqC"></div>
<div style="text-align:center;margin-top:14px">
<button class="bp1" id="rmqN" onclick="rmqNx()" style="display:none">Nächste Frage</button>
<button class="bp1" id="rmqRS" onclick="rmqSt()" style="display:none">Weiter üben</button>
<button id="rmqReset" onclick="rmqReset()" style="display:none;margin-left:8px">Fortschritt zurücksetzen</button>
</div>
</div>
