...
{t:'Aufgabe 17 — Retentionsrecht Hotel',q:'Frau Zwist war Gast im Hotel Krachhof. Sie beschwerte sich über den lausigen Service beim Hoteldirektor und kündigte ihm an, die Hotelrechnung nicht zu bezahlen. Der Hoteldirektor beschlagnahmte daraufhin eigenhändig das sich im Hotelzimmer befindliche Notebook und hinterlegte einen Zettel mit der Bemerkung «Wir behalten das Notebook als Pfand, bis Sie die Hotelrechnung bezahlt haben.»<br><br>Frau Zwist reiste erzürnt ab. Einige Tage später erhielt sie eine Betreibung auf Pfändung oder Konkurs vom zuständigen Betreibungsamt.<br><br>Was kann Frau Zwist alles unternehmen?',a:'<strong>1. Retentionsrecht des Gastwirts (Art. 491 OR):</strong> Der Gastwirt hat ein <strong>Retentionsrecht an eingebrachten Sachen</strong> des Gastes — aber nur solange sich der Gast im Hotel aufhält. Sobald Frau Zwist abgereist ist, erlischt das Retentionsrecht. Das eigenmächtige Zurückbehalten des Notebooks <strong>nach der Abreise</strong> ist nicht mehr vom Retentionsrecht gedeckt. Zudem: persönliche Gebrauchsgegenstände wie ein Notebook sind <strong>vom Retentionsrecht ausgenommen</strong>. Die Beschlagnahme ist daher <strong>widerrechtlich</strong> (evtl. Nötigung, Art. 181 StGB oder unrechtmässige Aneignung, Art. 137 StGB).<br><br><strong>2. Frau Zwist kann:</strong><br>• <strong>Herausgabe des Notebooks verlangen</strong> — die Beschlagnahme war widerrechtlich.<br>• <strong>Strafanzeige</strong> gegen den Hoteldirektor erwägen (Nötigung / unrechtmässige Aneignung).<br>• <strong>Rechtsvorschlag erheben</strong> (innert 10 Tagen) gegen die Betreibung, wenn sie die Forderung bestreitet.<br>• <strong>Beschwerde erheben</strong>, falls die Betreibungsart falsch ist: Frau Zwist als Privatperson → <strong>Pfändung</strong>, nicht Konkurs (ausser sie ist im HR eingetragen).<br>• <strong>Schadenersatzklage</strong> wegen der widerrechtlichen Beschlagnahme.'},
