...
<div class="c ck" onclick="schkgShowUeb(1)" style="text-align:center;padding:24px 16px"><div style="font-size:18px;font-weight:700;color:var(--g);margin-bottom:6px">📋</div><div class="ct2">Fallbeispiele</div><div class="cd">20 Fälle aus dem Kompendium</div></div>
...
<div style="text-align:center;margin-top:12px;font-size:11px;color:var(--tx3)" id="schkg_fall_count"></div>
</div>
...
document.getElementById('schkg_fall_count').textContent='Aufgabe '+(schkgFallIdx+1)+' von '+SCHKG_FAELLE.length;
};
