...
{t:'Aufgabe 6 — Paulianische Anfechtung',q:'Alice Schlyfer schenkt kurz vor der drohenden Schuldbetreibung ihre Ferienhäuser ihrem Partner. In der folgenden Betreibung erhält die Gläubigerin, Konstanze Eifrig, nur einen Pfändungsverlustschein.<br><br>Was kann sie unternehmen?',a:'<strong>Paulianische Anfechtung</strong> (Art. 285ff. SchKG).<br><br>Die Schenkung erfolgte kurz vor der Betreibung und ist daher <strong>anfechtbar</strong>:<br>• <strong>Schenkungsanfechtung</strong> (Art. 286): Schenkungen innerhalb des letzten Jahres vor der Pfändung können angefochten werden.<br>• Konstanze muss beim Gericht klagen und nachweisen, dass die Schenkung zum Nachteil der Gläubiger erfolgte.<br>• Bei Erfolg: Rückgabe der Ferienhäuser in die Konkursmasse.'},
{t:'Aufgabe 7 — Betreibungsart bestimmen',q:'Welche Betreibungsart ist zur Vollstreckung folgender Forderungen zu wählen?<br><br>a) Saalmiete gegen den Gesangsverein<br>b) Saalmiete gegen die Stiftung zur Förderung der Jugendkultur<br>c) Büromiete gegen eine einfache Gesellschaft<br>d) Steuern gegen eine Aktiengesellschaft<br>e) Grundpfandgesichertes Darlehen gegen einen Gesellschafter:in einer Kollektivgesellschaft',a:'<strong>a) Pfändung</strong> — Verein: im HR eingetragen oder nicht? Typisch nicht → Pfändung.<br><strong>b) Pfändung oder Konkurs</strong> — Stiftung im HR = Konkurs. Stiftung nicht im HR = Pfändung. (Die meisten Stiftungen sind im HR.)<br><strong>c) Pfändung</strong> — Einfache Gesellschaft hat keine Rechtspersönlichkeit und kann nicht im HR eingetragen werden. Betreibung gegen die <strong>einzelnen Gesellschafter</strong> → Pfändung.<br><strong>d) Konkurs</strong> — AG ist immer im HR eingetragen → Konkursbetreibung.<br><strong>e) Pfandverwertung</strong> — Grundpfandgesichert → immer Pfandverwertung (Art. 151 SchKG), unabhängig von der Person des Schuldners.'},
...
{t:'Aufgabe 9 — Schuldenberatung',q:'Enzo Rüdig hat soeben eine längere Haftstrafe verbüsst und erfolgreich einen Drogenentzug absolviert. Er arbeitet als Raumpfleger. Betreut wird er von einem Sozialarbeiter. Es sind sieben Betreibungen gegen ihn hängig, da er die Wohnungsmiete und Bankdarlehen nicht bezahlen kann.<br><br>Was raten Sie ihm?',a:'<strong>1. Schuldenberatung aufsuchen</strong> — Professionelle Hilfe (z.B. Caritas, Budgetberatung Schweiz).<br><strong>2. Existenzminimum berechnen</strong> — Bei Lohnpfändung wird nur der Betrag über dem Existenzminimum gepfändet (Art. 93 SchKG). Als Raumpfleger ist sein Lohn wahrscheinlich tief → wenig pfändbar.<br><strong>3. Vergleich anbieten</strong> — Mit den Gläubigern Ratenzahlung oder Teilerlass verhandeln.<br><strong>4. Kompetenzstücke kennen</strong> — Lebensnotwendige Gegenstände, Berufswerkzeuge etc. sind nicht pfändbar (Art. 92 SchKG).<br><strong>5. Keine neuen Schulden</strong> — Striktes Budget einhalten.'},
...
{t:'Aufgabe 16 — Konkurs Einzelfirma',q:'Die im Handelsregister eingetragene Einzelfirma «Bernd Brummer – Unternehmensberatung» wurde betrieben und schliesslich wurde der Konkurs eröffnet. Verschiedene Vermögenswerte erbrachten in der Verwertung einen Reinerlös von CHF 12\'000.–.<br><br>Wer erhält wie viel, wenn folgende Gläubiger:innen mit folgenden Forderungen (inkl. Zinsen und Kosten) beteiligt sind?<br>– Autoleasing AG, Forderung aus Leasingraten, CHF 3\'600.–<br>– Geschiedene Ex-Frau, Alimente für die letzten 9 Monate vor dem Konkursbegehren (9 × CHF 1\'000.–)<br>– Sparbank, Darlehen, CHF 11\'400.–',a:'<strong>Verteilung nach Konkursklassen:</strong><br><br><strong>1. Klasse:</strong> Ex-Frau Alimente — aber nur 6 Monate (Art. 219 SchKG: Unterhaltsbeiträge der letzten 6 Monate). → CHF 6\'000 (voll gedeckt aus CHF 12\'000)<br><br>Verbleibend: CHF 12\'000 – 6\'000 = CHF 6\'000<br><br><strong>2. Klasse:</strong> Keine Forderungen 2. Klasse vorhanden.<br><br><strong>3. Klasse:</strong> Autoleasing CHF 3\'600 + Sparbank CHF 11\'400 = Total CHF 15\'000.<br>Vorhanden: CHF 6\'000 → <strong>Dividende: 6\'000/15\'000 = 40%</strong><br>Autoleasing: CHF 1\'440 · Sparbank: CHF 4\'560<br><br>Restliche 3 Monate Alimente (CHF 3\'000) fallen in die 3. Klasse → auch nur 40% = CHF 1\'200.'},
{t:'Aufgabe 17 — Retentionsrecht Hotel',q:'Frau Zwist war Gast im Hotel Krachhof. Sie beschwerte sich über den lausigen Service beim Hoteldirektor und kündigte ihm an, die Hotelrechnung nicht zu bezahlen. Der Hoteldirektor beschlagnahmte daraufhin eigenhändig das sich im Hotelzimmer befindliche Notebook und hinterlegte einen Zettel mit der Bemerkung «Wir behalten das Notebook als Pfand, bis Sie die Hotelrechnung bezahlt haben.»<br><br>Frau Zwist reiste erzürnt ab. Einige Tage später erhielt sie eine Betreibung auf Pfändung oder Konkurs vom zuständigen Betreibungsamt.<br><br>Was kann Frau Zwist alles unternehmen?',a:'<strong>1. Retentionsrecht prüfen:</strong> Der Hotelier hat grundsätzlich ein <strong>Retentionsrecht</strong> (Art. 491 OR) an eingebrachten Sachen des Gastes — ABER nur an Sachen die «zu seiner Sicherheit» dienen. Ein Notebook ist eingebracht → Retention grundsätzlich zulässig.<br><br><strong>2. Rechtsvorschlag erheben</strong> (innert 10 Tagen), wenn Frau Zwist die Forderung oder deren Höhe bestreitet.<br><br><strong>3. Beschwerde prüfen:</strong> Ist die Betreibungsart korrekt? Frau Zwist als Privatperson → <strong>Pfändung</strong>, nicht Konkurs (es sei denn, sie ist im HR eingetragen).'},
{t:'Aufgabe 18 — Arrestbegehren',q:'Hat in den folgenden Fällen ein Arrestbegehren Aussicht auf Erfolg?<br><br>a) Frau Zwist ist auf Ferienreise. Unterwegs übernachtet sie im Hotel Krachhof. Da sie mit den Leistungen unzufrieden ist, erklärt sie am ersten Morgen, sie werde die Hotelrechnung am nächsten Tag nicht bezahlen. Die Rechnung ist gemäss Vereinbarung vor Abreise zu bezahlen.<br>b) Nach dem Tod von Pablo Emilio Escobar Gaviria, einem ehemaligen südamerikanischen Drogenbaron, findet man ein Bankkonto über mehrere Mio. US$ in der Schweiz. In den USA lebende Drogenopfer klagen auf 30 Mio. US$ Schadenersatz. Der Prozess läuft noch.<br>c) Ein Fahrender hat in einem Fernseh- und Radiogeschäft einen Fernseher gekauft und nicht bezahlt. Der Fernsehhändler weiss von Kollegen, dass der Fahrende in Sursee einen Lagerschuppen gemietet hat.',a:'<strong>a) Nein</strong> — Kein Arrestgrund. Die Rechnung ist noch nicht fällig (erst «vor Abreise»). Arrest setzt eine <strong>fällige Forderung</strong> voraus + einen der Arrestgründe nach Art. 271 SchKG.<br><br><strong>b) Ja, gute Chancen</strong> — Arrestgrund: Schuldner hat keinen Wohnsitz in der Schweiz (Art. 271 Abs. 1 Ziff. 4). Arrestgegenstand: Bankkonto in der Schweiz. Aber: Forderung muss glaubhaft gemacht werden.<br><br><strong>c) Ja</strong> — Arrestgrund: Schuldner hat keinen festen Wohnsitz (Fahrender = kein fester Wohnsitz, Art. 271 Abs. 1 Ziff. 1). Arrestgegenstand: Vermögenswerte im Lagerschuppen in Sursee.'},
{t:'Aufgabe 19 — Provisorische Rechtsöffnung & Arrest',q:'Charlotte Brotlos ist im HR des Kantons Zürich als Einzelunternehmerin eingetragen. Balduin Reich wurde dank des Darlehensvertrages provisorische Rechtsöffnung erteilt. Er hat erfahren, dass Charlotte Brotlos daran ist, ihre Boutique zu verschenken, um diese vor dem Konkurs zu retten.<br><br>Was ist wo und bei wem zu unternehmen?',a:'<strong>1. Arrest beantragen!</strong> (Art. 271 Abs. 1 Ziff. 2 SchKG) — Arrestgrund: Schuldnerin beseitigt Vermögenswerte (Verschenkung = Vermögensverschleuderung).<br>• Wo: Beim <strong>Gericht am Ort</strong>, wo sich die Boutique befindet.<br>• Sofort handeln, bevor die Schenkung vollzogen ist!<br><br><strong>2. Konkursbegehren stellen</strong> — Charlotte ist im HR → Konkursbetreibung. Nach provisorischer Rechtsöffnung kann das Konkursbegehren gestellt werden.<br><br><strong>3. Evtl. Paulianische Anfechtung</strong> vorbereiten — falls die Schenkung bereits vollzogen wurde.'},
{t:'Aufgabe 20 — Konkursverhandlung',q:'Nachdem Balduin Reich das Fortsetzungsbegehren gestellt hatte, erhielt Charlotte Brotlos die Konkursandrohung. Sie zahlte daraufhin CHF 20\'000, den Rest blieb sie schuldig. Balduin Reich stellte deshalb das Konkursbegehren beim zuständigen Richter. Wie wird dieser entscheiden, wenn Charlotte Brotlos in der Verhandlung Folgendes geltend macht?<br><br>a) Sie habe den Darlehensvertrag über CHF 100\'000 zwar unterzeichnet, als Darlehenssumme aber nur CHF 20\'000 erhalten. Diese habe sie zurückbezahlt.<br>b) Die Konkursandrohung sei ihr während der Betreibungsferien zugestellt worden und deshalb ungültig.<br>c) Sie sei vor gut einem Jahr aus dem HR gelöscht worden und unterstehe nicht mehr der Konkursbetreibung.<br>d) Sie habe mit Balduin Reich schriftlich vereinbart, dass dieser die Betreibung nicht fortsetze, wenn sie eine Anzahlung von CHF 20\'000 leiste, was sie getan habe.',a:'<strong>a) Irrelevant</strong> — Provisorische Rechtsöffnung wurde bereits erteilt. Charlotte hätte innert 20 Tagen <strong>Aberkennungsklage</strong> erheben müssen. Wenn sie das nicht getan hat, ist die Forderung definitiv.<br><strong>b) Prüfen!</strong> — Zustellung während Betreibungsferien (Art. 56 SchKG) ist <strong>nichtig</strong>. Wenn die Konkursandrohung tatsächlich während der Ferien (7 Tage vor/nach Ostern/Weihnachten, 15.–31. Juli) zugestellt wurde → Verfahren ist fehlerhaft.<br><strong>c) Kein Hindernis</strong> — Wer einmal im HR war, untersteht der Konkursbetreibung, solange <strong>die Betreibung vor der Löschung eingeleitet</strong> wurde.<br><strong>d) Abweisung möglich</strong> — Wenn die schriftliche Vereinbarung echt ist, könnte das Konkursbegehren abgewiesen werden (Stundungsvereinbarung).'},
