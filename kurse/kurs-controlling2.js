...
<div class="hla"><strong>🏨 Fallbeispiel Hotel Bellavista Luzern ★★★★</strong><br>Begleitet dich durch alle Kapitel: 4-Sterne-Stadthotel am Vierwaldstättersee, <strong>80 Zimmer</strong>, Restaurant «Vista» (90 Plätze), Wellnessbereich «Spa Aqua», Seminarraum 180 m², 45 Mitarbeitende. Jahresumsatz ca. <strong>CHF 12 Mio.</strong>, Inhaberin/Direktorin: <strong>Claudia Bellavista</strong>. Monatswerte Jan 2024: OCC 70%, ADR CHF 245, RevPAR CHF 171.50.</div>
...
<div class="hla"><strong>🏨 Bellavista im Fokus — Restaurant «Vista»:</strong> Tagesteller CHF 28.50 (variable Kosten CHF 9.20) → DB CHF 19.30 (67.7%). Mittagsmenü Salatbuffet CHF 24.00 (variable Kosten CHF 7.80) → DB CHF 16.20 (67.5%). Weihnachtsbankett-Package CHF 120/Person (variable Kosten CHF 45) → DB CHF 75. Fixkosten Bankett CHF 9'000 → Nutzschwelle = 120 Gäste.</div>
...
<div class="hla"><strong>🏨 Bellavista — Investitionsportfolio 2024:</strong> <strong>Ersatz</strong> Wäschereianlage (Zwangsinvestition, CHF 180'000) · <strong>Erweiterung</strong> Wellness um Indoor-Pool (CHF 750'000) · <strong>Umstellung+Rationalisierung</strong> Photovoltaikanlage (CHF 320'000) · <strong>Sicherung/Immateriell</strong> neues PMS-System (CHF 85'000). <strong>Gesamtvolumen CHF 1'335'000.</strong></div>
